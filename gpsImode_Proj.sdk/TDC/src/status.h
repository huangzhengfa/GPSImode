...
#define STATUS_BASEADDR XPAR_STATUS_0_STATUS_AXI_BASEADDR

#define LED_CTRL_OFFSET  0
#define INIT_LED_ON  1
#define INIT_LED_OFF  0
#define READY_LED_ON 1<<1
#define READY_LED_OFF 0<<1
