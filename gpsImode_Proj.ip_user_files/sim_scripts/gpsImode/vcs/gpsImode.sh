...
#
# Generated by Vivado on Wed Oct 17 10:18:59 +0800 2018
...
vhdlan_opts="-full64"
vcs_elab_opts="-load "D:/ProgramFiles/Xilinx/Vivado/2016.2/lib/win64.o/libxil_vcs.dll:xilinx_register_systf" -full64 -debug_pp -t ps -licqueue -l elaborate.log"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    ...
    "$ref_dir/../../../bd/gpsImode/ipshared/xilinx.com/status_v1_0/hdl/Status_v1_0_STATUS_AXI.v" \
    "$ref_dir/../../../bd/gpsImode/ipshared/xilinx.com/status_v1_0/hdl/Status_v1_0.v" \
    "$ref_dir/../../../bd/gpsImode/ip/gpsImode_Status_0_0/sim/gpsImode_Status_0_0.v" \
  2>&1 | tee -a vlogan.log
